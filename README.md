...
> #### _`ข้อเสีย`_
>
> - ในกรณีที่การ query ข้อมูลมีความซับซ้อนมากๆ การเขียน `L2E` เพื่อให้ Entity ทำงานได้ตรงตามความต้องการอาจจะค่อนข้างยาก เพราะฉะนั้นอาจจะต้องเขียน Query บน View Table หรือ Store Procedure แทนจะทำงานได้เร็วกว่า Entity
